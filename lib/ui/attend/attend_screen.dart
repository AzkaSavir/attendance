...
class AttendScreen extends StatefulWidget {
  final XFile?
      image; // xfile gunanya agar gambarnya bisa di ubah dan kenapa di kasih tanda tanya / nullable karena saat di home screen kita kan gapunya gambar jadi bisa di nullable in dulu
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        borderRadius: BorderRadius.circular(20),
                        onTap: () {
                          if (image == null || controllerName.text.isNotEmpty) {
            ...
            const SnackBar(
              content: Row(
                children: [
                  ...
                  Text("yeay! Your Attendance Successfully recorded")
                ],
              ),
